...
if args.dataset =='STL10':
    ...
    datasets.STL10('~/dataset', split='unlabeled', download=True,
    ...
    loader = torch.utils.data.DataLoader(
    datasets.CIFAR10('/home/mk/dataset', train=True, download=True,
        transform=transforms.Compose([
            transforms.Scale(32),
            transforms.ToTensor(),
            transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))])),
...
if args.model == 'resnet':
    if args.dataset =='STL10':
        import model_resnet_STL10 as model
    else:
        import model_my_resnet as model
else:
    if args.dataset =='STL10':
        import model_stl as model
    else:
        import model
...
ckp_mdf = args.checkpoint_dir.format(args.model,( 'STL10' if args.dataset =='STL10' else 'cifar'),mdf(d_lrs))
