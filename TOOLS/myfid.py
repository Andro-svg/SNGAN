...
def _handle_path(path, sess):
    if path.endswith('.npz'):
        ...
        m, s = calculate_activation_statistics(x, sess, batch_size=50)#args.batch_size)
    return m, s
...
def calculate_fid_given_paths(paths, inception_path):
    ...
    log_output = open("{}/log_FID.txt".format("./log_dir"), 'a')#args.output_dir), 'a')
    ...
    with v1.Session(config=config) as sess:
        ...
        s = '%s / Iter %06d : %.4f'  % ("FID of:",100000,fid_value)#args.output_name, args.at, fid_value)
...
models_path = '/home/super/ZZX/Self-Attention-GAN-master/models/sagan_1'
cifar5000_path = "/home/super/ZZX/cifar-10-batches-py/5000"
#p="/home/super/ZZX/RelativisticGAN-master/code/extra/2_"
os.environ['CUDA_VISIBLE_DEVICES'] = '0'
if __name__ == '__main__':
	import sys
	fid_value = calculate_fid_given_paths([sys.argv[1],sys.argv[2]],"./data")
	print("FID: ", fid_value)
